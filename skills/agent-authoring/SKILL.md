...
Do not draft `AgentPackageSpec` or stage files until material design questions are resolved and the operator has reviewed the design summary. If the operator already provides a complete approved design, do not repeat the interview unnecessarily.
