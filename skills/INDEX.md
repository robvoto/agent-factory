# Skills Index — Agent Factory Platform
...
- [deepagents-factory/SKILL.md](deepagents-factory/SKILL.md) — create LangChain Deep Agents correctly; tools, memory, human-in-the-loop
- [documentation-hygiene/SKILL.md](documentation-hygiene/SKILL.md) — when to update docs; triggered update table; data and settings docs
- [permission-review/SKILL.md](permission-review/SKILL.md) — review risk before enabling an agent; risk categories; fallback/shim review
